...
global $CONFIG;
$pageId=$_GET['id'];
$title = Commerce::isCategoryItem($pageId, "title");
$catId = Commerce::isCategoryItem($pageId, "id");
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadscrumb-contain">
                        <h2> Categoria / <?= Commerce::isCategoryItem($pageId, "title"); ?> </h2>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div
                        ...
                        <?php 
                                ...
                                foreach ($data as $item) {
                                    ...
                                    $weight = $item->weight;
                                    if($item->categories == $catId AND $count <= $productPorPagina AND $productType != 'variation' AND $item->status == "enabled") {
                          ?>
                            <div>
