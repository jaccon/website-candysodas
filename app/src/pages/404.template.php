...
<body class="bg-effect">
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="contain-404">
                        ...
                        <a href="<?= $siteUrl; ?>" class="btn btn-md text-white theme-bg-color mt-4 mx-auto">
                            <?= $buttonText; ?>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="footer-contact">
                            <ul>
                                ...
                                <li class="social-app mb-0">
                                    ...
                                    <ul>
                                        <li class="mb-0">
                                            <a href="../../../play.google.com/store/apps.html" target="_blank">
                                                <img src="../assets/images/playstore.svg" class="blur-up lazyload"
                                                    alt="">
                                            </a>
                                        </li>
                                        <li class="mb-0">
                                            <a href="../../../www.apple.com/in/app-store/index.html" target="_blank">
            ...
            <div class="sub-footer section-small-space">
                ...
                <div class="social-link">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="../../../twitter.com/index.html" target="_blank">
                        ...
                        <li>
                            <a href="../../../in.pinterest.com/index.html" target="_blank">
    ...
    <div class="setting-box buy-now mt-2"><a class="btn setting-button" href="../../../themeforest.net/cart/configure_before_adding/39085476bb26.html" target="_blank"><i class="fa-solid fa fa-cart-flatbed"></i></a></div>
