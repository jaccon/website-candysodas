<div class="section-full p-t90 p-lr80 latest_project-outer square_shape3">
                ...
                <div class="section-head text-left">
                    <div class="row">
                    	<div class="col-md-4">
                            <h2 class="text-uppercase font-36">Últimos Projetos </h2>
                        ...
                        <div class="col-md-8">
                            <ul class="btn-filter-wrap">
                                <li class="btn-filter btn-active" data-filter="*">Todos projetos</li>
                                <li class="btn-filter" data-filter=".building-col">Arquitetura</li>
                                <li class="btn-filter" data-filter=".interior-col">Interiores</li>
