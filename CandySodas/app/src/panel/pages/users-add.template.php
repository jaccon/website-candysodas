...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (helperUsers::saveUsersData($dataToSave)) {
                                    ...
                                    <div class="card-body border-top p-9">
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                            <span class="required"> <?= MYACCOUNT_09; ?> </span>
                                         </label>
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> <?= MYACCOUNT_07; ?> </label>
                                          <div class="col-lg-8">
                                             <div class="row">
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> <?= MYACCOUNT_10; ?> </span>
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                            <span class="required"> <?= MYACCOUNT_11; ?>  </span>
                                          </label>
                                          <div class="col-lg-8 fv-row">
                                            <input 
                                              type="text" 
                                      ...
                                      <div class="row mb-6">
                                          ...
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> <?= USERS_USERGROUP; ?> </label>
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <select 
                                              ...
                                              >
                                                <option value="admin"> <?= USERS_USERGROUP_TYPE1; ?> </option>
                                                <option value="supplyer"> <?= USERS_USERGROUP_TYPE2; ?> </option>
                                                <option value="customer"> <?= USERS_USERGROUP_TYPE3; ?> </option>
                                             </select>
                                             <div class="form-text">
                                                <?= USERS_USERGROUP_SELECT; ?>
                                             </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="row mb-6">
                                          ...
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> <?= USERS_DEFAULT_LANGUAGE; ?> </label>
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                            <span class="required"> <?= USERS_PASSWORD; ?>  </span>
                                          </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              type="text" 
