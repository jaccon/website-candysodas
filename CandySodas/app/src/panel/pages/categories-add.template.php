...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (CMS::saveCategory($dataToSave)) {
                                 ...
                                 <form 
                                    ...
                                    <div class="card-body border-top p-9">
                                      ...
                                      <div class="row mb-6">
                                          ...
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> <?= CAT_06; ?> </label>
                                      ...
                                      <div class="row mb-6">
                                          ...
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> <?= CAT_08; ?> </label>
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <select 
                                                ...
                                                class="form-select form-select-solid form-select-lg"
                                              >
                                                <option value="posts">  <?= CAT_09; ?> </option>
                                                <option value="pages"> <?= CAT_10; ?> </option>
                                                <option value="products"> <?= CAT_11; ?> </option>
                                             </select>
                                             <div class="form-text">
                                                <?= CAT_12; ?>
                                             </div>
