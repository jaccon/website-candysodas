...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (helperForms::saveForm($dataToSave)) {
                                 ...
                                 <form 
                                    ...
                                    <div class="card-body border-top p-9">
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <span class="ms-1"  data-bs-toggle="tooltip" title="E-mail to receive all replies messages" >
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> Reply To Name </span>
                                          <span class="ms-1"  data-bs-toggle="tooltip" title="E-mail to receive all replies messages" >
                                          <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>                    </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              name="replyToName" 
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="Reply to Name show who send the e-mail" 
                                              />
                                          </div>
                                       </div>
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              name="replyTo" 
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="E-mail to send replies" 
                                              />
                                          </div>
                                       </div>
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                              ...
                                              <div class="form-text">
                                                  The form status to capture leads. If disabled no capture leads
                                              </div>
                                          </div>
                                      </div>
