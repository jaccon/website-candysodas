...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $dataToSave = [
    'id' => $_POST['uuid'],  // Usa o UUID que foi gerado ou passado no formulário
    'title' => $_POST['title'],
  ...
  if (CMS::saveSlideshow($dataToSave)) {
    $message = "Registro salvo com sucesso!";
    $success = true;
    header('Location: slideshow-update.html?id=' . $_POST['uuid']);
  } else {
                        ...
                        <div id="kt_app_content" class="app-content pb-0">
                           ...
                           <div class="card mb-5 mb-xl-10">
                              ...
                              <div id="kt_account_settings_profile_details" class="collapse show">
                                 <form method="POST" enctype="multipart/form-data" action="?success=true">
      ...
      <script>
         async function fetchUuid() {
            try {
                  ...
                  document.getElementById('uuid').value = uuid;  // Coloca o UUID gerado pela API no campo oculto
                  console.log('UUID gerado pela API:', uuid);
            } catch (error) {
                  console.error(error);
         ...
         // Chama a função fetchUuid na carga da página
