...
$registerId = $_GET['id'] ?? $_GET['id'];
$projectData = null;

if ($registerId) {
    $loadData = CMS::getComponentsById($registerId);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (CMS::updateComponentsById($registerId, $dataToSave)) {
...
<html lang="en" >
   ...
   <body  
                  ...
                  <div class="app-main flex-column flex-row-fluid " id="kt_app_main">
                     <div class="d-flex flex-column flex-column-fluid">
                              ...
                              <div class="d-flex flex-stack flex-wrap gap-4 w-100">
                                 <div class="page-title d-flex flex-column gap-3 me-3">
                                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-2x my-0">
                                       Component  / <?= $loadData['componentName']; ?>
                                    </h1>
                          ...
                          <?php include('../components/my-account/resume.inc.php'); ?>
                           ...
                           <div class="card mb-5 mb-xl-10">
                              ...
                              <div class="card-header border-0 cursor-pointer" >
                                 ...
                                 <a href="components.html" class="btn btn-sm btn-secondary align-self-center">
                                    Ver todos
                                 </a>
                              ...
                              <div id="kt_account_settings_profile_details" class="collapse show">
                                 ...
                                 <form 
                                    ...
                                    <div class="card-body border-top p-9">
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                            <span class="required"> Component Name </span>
                                         </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              type="text" 
                                              ...
                                              value="<?= $loadData['componentName']; ?>"
                                              readonly
                                              />
                                              <small class="text-gray-500"> The component name is reference to call the component from code</small>
                                          </div>
                                       </div>
                        ...
                        <div class="card card-flush py-4">
                           ...
                           <div class="card-title m-0">
                                 <h3 class="fw-bold m-0"> Component Metadata </h3>
                           </div>
                           <button 
                              type="button" 
      ...
      <?php 
        $metaOrigin = 'components';
        $componentId = Security::inputSanitizer($registerId);
        include('../components/modals/add-metadata/add-metadata-component.inc.php');
      ?>
      ...
      <script>
         ...
         const componentNameInput = document.querySelector('input[name="componentName"]');
         ...
         titleInput.addEventListener('input', function(e) {
            componentNameInput.value = normalizeText(e.target.value);
         });
