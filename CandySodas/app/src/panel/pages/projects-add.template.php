...
include(__DIR__ . '/../components/custom/projects/save.inc.php'); 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $dataToSave = [
    ...
    'profit' => $_POST['profit'],
    'createdAt' => date('Y-m-d H:i:s') // Adiciona a data atual no formato desejado
];

  if (saveProjectData($dataToSave)) {
                              ...
                              <div id="kt_account_settings_profile_details" class="collapse show">
                                 ...
                                 <form 
                                    ...
                                    <div class="card-body border-top p-9">
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> <?= PRJ_ADD_06; ?> </span>
                                          <span class="ms-1"  data-bs-toggle="tooltip" title="Choose a customer" >
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             ...
                                             <?php $customers = helperCustomers::getEnabledCustomers($customersFile); ?>
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                             <span class="required"> <?= PRJ_ADD_07; // Project Deadline?>  </span>
                                          </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              type="date" 
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              value="<?= htmlspecialchars($totalProjectCost); ?>" />
                                          </div>
                                       </div>
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              value="<?= htmlspecialchars($totalLaborCost); ?>" />
                                          </div>
                                       </div>
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <select 
                                                ...
                                                class="form-select form-select-solid form-select-lg"
                                              >
                                                <option value="1"> <?= PRJ_PAY_01; ?> </option>
                                                <option value="2"> <?= PRJ_PAY_02; ?> </option>
                                                <option value="3"> <?= PRJ_PAY_03; ?> </option>
                                                <option value="4"> <?= PRJ_PAY_04; ?></option>
                                                <option value="5"> <?= PRJ_PAY_05; ?>  </option>
                                                <option value="6"> <?= PRJ_PAY_06; ?> </option>
                                             </select>
                                             <div class="form-text">
                                                <?= PRJ_PAY_STR; ?>
                                             </div>
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                             <span class="required"> <?= PRJ_PAY_STR_02; ?>  </span>
                                          </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              type="text" 
                                              name="installments" 
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="<?= PRJ_PAY_STR_02; ?>" 
                                              value="<?= htmlspecialchars($installments); ?>" />
                                          </div>
                                       </div>
