...
if ($postId) {
    $loadData = Cms::getPostsById($postId);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Se 'categories_string' não for enviado no POST, mantém o valor já salvo
  ...
  if (CMS::updatePost($postId, $dataToSave)) {
                              ...
                              <div class="d-flex flex-stack flex-wrap gap-4 w-100">
                                 <div class="page-title d-flex flex-column gap-3 me-3">
                                    ...
                                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-2x my-0">
                                      <span id="gTitle"> Update Post</span>
                                    </h1>
