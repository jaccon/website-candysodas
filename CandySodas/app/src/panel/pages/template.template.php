...
<div class="d-flex flex-grow-1 flex-lg-grow-0">
    ...
    <div class="d-flex align-items-center me-7" id="kt_app_header_logo_wrapper">
        ...
        <a href="index.html" class="d-flex align-items-center mb-1 mb-lg-0 pt-lg-1">
            <img alt="Logo" src="assets/media/logos/default.svg" class=""/>             
        </a>
        <!--end::Logo-->         
    </div>
    <!--end::Logo wrapper-->    
...
<div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible py-6" data-kt-menu-dismiss="true">
    ...
    <div class="row px-5">
            ...
            <div class="col-lg-6 py-1">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="social.html" class="menu-link ">
                        <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
            ...
            <div class="col-lg-6 py-1">
                ...
                <div class="menu-item p-0 m-0">
                    <!--begin:Menu link-->
                    <a href="logistics.html" class="menu-link ">
                        <span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
...
<!--end:Dashboards menu--></div><!--end:Menu sub--></div><!--end:Menu item--><!--begin:Menu item--><div  data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"  class="menu-item menu-here-bg menu-lg-down-accordion me-0 me-lg-2" ><!--begin:Menu link--><span class="menu-link"  ><span  class="menu-title" >Account</span><span  class="menu-arrow d-lg-none" ></span></span><!--end:Menu link--><!--begin:Menu sub--><div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px" ><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/overview.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Overview</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/settings.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Settings</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/security.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Security</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/activity.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Activity</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/billing.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Billing</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/statements.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Statements</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/referrals.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Referrals</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/api-keys.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >API Keys</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="account/logs.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Logs</span></a><!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub--></div><!--end:Menu item--><!--begin:Menu item--><div  data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"  class="menu-item menu-lg-down-accordion me-0 me-lg-2" ><!--begin:Menu link--><span class="menu-link"  ><span  class="menu-title" >Pages</span><span  class="menu-arrow d-lg-none" ></span></span><!--end:Menu link--><!--begin:Menu sub--><div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px" ><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/about.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >About</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/team.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Our Team</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/faq.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >FAQ</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/contact.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Contact Us</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/pricing.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Pricing</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/licenses.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Licenses</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/sitemap.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Sitemap</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/careers/list.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Careers List</span></a><!--end:Menu link--></div><!--end:Menu item--><!--begin:Menu item--><div  class="menu-item" ><!--begin:Menu link--><a class="menu-link"  href="pages/careers/apply.html"  ><span  class="menu-bullet" ><span class="bullet bullet-dot"></span></span><span  class="menu-title" >Careers Apply</span></a><!--end:Menu link--></div><!--end:Menu item--></div><!--end:Menu sub--></div><!--end:Menu item--><!--begin:Menu item--><div  data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"  class="menu-item menu-lg-down-accordion me-lg-1" ><!--begin:Menu link--><span class="menu-link"  ><span  class="menu-title" >Authentication</span><span  class="menu-arrow d-lg-none" ></span></span><!--end:Menu link--><!--begin:Menu sub--><div  class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown p-0 w-lg-600px" ><!--begin:Pages menu-->
...
<div data-kt-search-element="results" class="d-none">
    ...
    <div class="scroll-y mh-200px mh-lg-350px">
            ...
            <!--end::Category title-->
                                    ...
                                    <!--begin::Item-->
                    <a href="projects.html#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-6.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="projects.html#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-2.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="projects.html#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-14.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
                    ...
                    <a href="projects.html#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                        <!--begin::Symbol-->
                        <div class="symbol symbol-40px me-4">
                            <img src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-11.jpg" alt=""/>
                        </div>
                        <!--end::Symbol-->
...
<div class="mb-5" data-kt-search-element="main">
    ...
    <div class="scroll-y mh-200px mh-lg-325px">
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <!--begin::Title-->
                <div class="d-flex flex-column">
                    <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">BoomApp by Keenthemes</a>
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <!--begin::Title-->
                <div class="d-flex flex-column">
                    <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Kept API Project Meeting</a>
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <!--begin::Title-->
                <div class="d-flex flex-column">
                    <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"KPI Monitoring App Launch</a>
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <!--begin::Title-->
                <div class="d-flex flex-column">
                    <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Project Reference FAQ</a>
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <!--begin::Title-->
                <div class="d-flex flex-column">
                    <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"FitPro App Development</a>
                    <span class="fs-7 text-muted fw-semibold">#84250</span>
                </div>
                <!--end::Title-->
            </div>
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <!--begin::Title-->
                <div class="d-flex flex-column">
                    <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">Shopix Mobile App</a>
            ...
            <div class="d-flex align-items-center mb-5">
                ...
                <!--begin::Title-->
                <div class="d-flex flex-column">
                    <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-semibold">"Landing UI Design" Launch</a>
...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true" id="kt_menu_notifications">
    ...
    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('../assets/media/misc/menu-header-bg.jpg')">
        ...
        <ul class="nav nav-line-tabs nav-line-tabs-2x nav-stretch fw-semibold px-9">
            <li class="nav-item">
                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="projects.html#kt_topbar_notifications_1">Alerts</a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4 active" data-bs-toggle="tab" href="projects.html#kt_topbar_notifications_2">Updates</a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-white opacity-75 opacity-state-100 pb-4" data-bs-toggle="tab" href="projects.html#kt_topbar_notifications_3">Logs</a>
            </li>
        </ul>
        <!--end::Tabs-->
    </div>
            ...
            <div class="scroll-y mh-325px my-5 px-8">
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Alice</a>
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">HR Confidential</a>
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Company HR</a>
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Redux</a>
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Project Breafing</a>
 ...
 fs-2 text-info"></i>                                                    
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Banner Assets</a>
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="projects.html#" class="fs-6 text-gray-800 text-hover-primary fw-bold">Icon Assets</a>
            ...
            <div class="d-flex flex-column px-9">
                ...
                <div class="pt-10 pb-0">
                    ...
                    <div class="text-center mt-5 mb-9">
                        <a href="projects.html#" class="btn btn-sm btn-primary px-6"  data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan" >Upgrade</a>                  
                    </div>
                    <!--end::Action-->
                </div>
                <!--end::Section-->
            ...
            <div class="scroll-y mh-325px my-5 px-8">
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">New order</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">New customer</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">Payment process</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">Search query</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">API connection</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">Database restore</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">System update</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">Server OS update</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">API rollback</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">Refund process</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">Withdrawal process</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center me-2">
                            ...
                            <!--begin::Title-->
                            <a href="projects.html#" class="text-gray-800 text-hover-primary fw-semibold">Mail tasks</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
    ...
    <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
        <a href="projects.html#" class="menu-link px-5">
...
<!--end::User account menu-->
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3">
        <a href="projects.html#" class="btn btn-flex btn-sm flex-center btn-success h-30px px-3"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">
            New <span class="d-none d-sm-block ps-1">App</span>
        </a>  
    </div>
    <!--end::Invite-->
...
<div class="app-content-menu menu menu-rounded min-w-700px align-items-center">
		...
		<div class="menu-item">
			<a 
                ...
                href="index.html"
            >
                <span class="menu-title flex-shrink-0">
                    Default                </span>
			</a>
		</div>
		<!--end::Menu item-->
		...
		<div class="menu-item">
			<a 
                class="menu-link px-6 py-4 active" 
                href="projects.html"
            >
                <span class="menu-title flex-shrink-0">
                    Projects                </span>
...
<!--end::Page title-->         
    ...
    <div class="d-flex align-items-center gap-3 gap-lg-5">
        ...
        <div class="m-0">            
            <a href="projects.html#" class="btn btn-flex btn-sm btn-color-gray-700 bg-body fw-bold px-4"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_project">                         
                New Project
            </a>           
        </div>
        ...
        <a href="projects.html#" class="btn btn-flex btn-center btn-dark btn-sm px-4"  data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
    ...
    <div class="card-body d-flex flex-column justify-content-end pe-0">
        ...
        <div class="symbol-group symbol-hover flex-nowrap">
                            ...
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
                                            <img alt="Pic" src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-11.jpg" />
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
                                            <span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
                                    </div>
                            <div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
                                            <img alt="Pic" src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-2.jpg" />
                                    </div>
                        ...
                        <a href="projects.html#" class="symbol symbol-35px symbol-circle"  data-bs-toggle="modal" data-bs-target="#kt_modal_view_users">
...
<div class="card h-md-100">
    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar">   
            <a href="projects.html#" class="btn btn-sm btn-light">Report Cecnter</a>             
        </div>
        <!--end::Toolbar-->
    </div>
    <!--end::Header-->
    ...
    <div class="card-body pt-7 px-0">
        ...
        <ul class="nav nav-stretch nav-pills nav-pills-custom nav-pills-active-custom d-flex justify-content-between mb-8 px-5">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_1">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_2">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_3">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger active" data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_4">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_5">
                        <span class="fs-7 fw-semibold">Tu</span>
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_6">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_7">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_8">
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_9">
                        <span class="fs-7 fw-semibold">Sa</span>
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_10">
                        <span class="fs-7 fw-semibold">Su</span>
                ...
                <li class="nav-item p-0 ms-0">
                    <!--begin::Date-->
                    <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 btn-active-danger " data-bs-toggle="tab" href="projects.html#kt_timeline_widget_3_tab_content_11">
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <div class="text-gray-500 fw-semibold fs-7">
                                    Lead by 
                                    <!--begin::Name-->
                                    <a href="projects.html#" class="text-primary opacity-75-hover fw-semibold">Peter Marcus</a>                  
                                    <!--end::Name-->  
                                </div>
                                <!--end::Link-->
                            </div>
                            ...
                            <!--begin::Action-->                            
                            <a href="projects.html#" class="btn btn-sm btn-light"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_project">View</a>                               
                            <!--end::Action-->  
                        </div>
                        <!--end::Wrapper-->
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <div class="text-gray-500 fw-semibold fs-7">
                                    Lead by 
                                    <!--begin::Name-->
                                    <a href="projects.html#" class="text-primary opacity-75-hover fw-semibold">Lead by Bob</a>                  
                                    <!--end::Name-->  
                                </div>
                                <!--end::Link-->
                            </div>
                        ...
                        <div class="d-flex align-items-center mb-6">
                            ...
                            <div class="flex-grow-1 me-5">
                                ...
                                <div class="text-gray-500 fw-semibold fs-7">
                                    Lead by 
                                    <!--begin::Name-->
                                    <a href="projects.html#" class="text-primary opacity-75-hover fw-semibold">Lead by Mark Morris</a>                  
                                    <!--end::Name-->  
                                </div>
                                <!--end::Link-->
                            </div>
        ...
        <div class="float-end d-none">
            <a href="projects.html#" class="btn btn-sm btn-light me-2"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_project">Add Lesson</a>

            <a href="projects.html#" class="btn btn-sm btn-danger"  data-bs-toggle="modal" data-bs-target="#kt_modal_create_app">Call Sick for Today</a>
        </div>
        <!--end::Action-->  
    </div>
    <!--end: Card Body-->
                ...
                <div id="kt_schedule_day_2" class="tab-pane fade show ">
                        ...
                        <div class="d-flex flex-stack position-relative mt-8">
                            ...
                            <div class="fw-semibold ms-5 text-gray-600">
                                ...
                                <!--begin::User-->
                                <div class="text-gray-500">
                                    Lead by <a href="projects.html#">Karina Clarke</a>
                                </div>
                                <!--end::User-->
                            </div>
                            <!--end::Info-->
    ...
    <div class="card-body"> 
        ...
        <div class="row align-items-center h-100">
            ...
            <div class="col-5 pt-10">
                <!--begin::Illustration-->
                <div class="bgi-no-repeat bgi-size-contain bgi-position-x-end h-225px" style="background-image:url('/oliver-html-pro/assets/media/svg/illustrations/easy/5.svg">                 
                </div>
                <!--end::Illustration-->
            </div>
            <!--end::Col--> 
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="projects.html#" class="menu-link px-3">
            New Ticket
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <div class="menu-item px-3">
        <div class="menu-content px-3 py-3">
            <a class="btn btn-primary  btn-sm px-4" href="projects.html#">
                Generate Reports
            </a>
        </div>
    </div>
        ...
        <ul class="nav d-flex justify-content-between mb-3 mx-9">
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px active" data-bs-toggle="tab" id="kt_charts_widget_35_tab_1" 
                        href="projects.html#kt_charts_widget_35_tab_content_1">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_2" 
                        href="projects.html#kt_charts_widget_35_tab_content_2">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_3" 
                        href="projects.html#kt_charts_widget_35_tab_content_3">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_4" 
                        href="projects.html#kt_charts_widget_35_tab_content_4">               
                ...
                <li class="nav-item mb-3">
                    ...
                    <a class="nav-link btn btn-flex flex-center btn-active-danger btn-color-gray-600 btn-active-color-white rounded-2 w-45px h-35px " data-bs-toggle="tab" id="kt_charts_widget_35_tab_5" 
                        href="projects.html#kt_charts_widget_35_tab_content_5">               
                    ...
                    <div class="table-responsive mx-9 mt-n6">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">2:30 PM</a>                                            
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">3:10 PM</a>                                            
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">3:55 PM</a>                                            
                                        </td>
                    ...
                    <div class="table-responsive mx-9 mt-n6">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">4:30 PM</a>                                            
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">11:35 AM</a>                                            
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">3:30 PM</a>                                            
                                        </td>
                    ...
                    <div class="table-responsive mx-9 mt-n6">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">3:20 AM</a>                                            
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">12:30 AM</a>                                            
                                        </td>
                    ...
                    <div class="table-responsive mx-9 mt-n6">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">5:30 AM</a>                                            
                                        </td>
                    ...
                    <div class="table-responsive mx-9 mt-n6">
                        ...
                        <table class="table align-middle gs-0 gy-4">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">3:30 AM</a>                                            
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="projects.html#" class="text-gray-600 fw-bold fs-6">10:30 PM</a>                                            
                                        </td>
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                ...
                <tbody>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="projects.html#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Mivy App</a>
                            ...
                            <td class="text-end">
                                <a href="projects.html#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="projects.html#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Avionica</a>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="projects.html#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Charto CRM</a>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="projects.html#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Tower Hill</a>
                        ...
                        <tr>                            
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                        <a href="projects.html#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">9 Degree</a>
    ...
    <div class="card-header position-relative py-0 border-bottom-1">
        ...
        <ul class="nav nav-stretch nav-pills nav-pills-custom d-flex mt-4">
            ...
            <li class="nav-item p-0 ms-0">
                ...
                data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="projects.html#kt_timeline_widget_4_tab_day"> 
                    <!--begin::Title-->
            ...
            <li class="nav-item p-0 ms-0">
                ...
                data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="projects.html#kt_timeline_widget_4_tab_week">
                <!--begin::Title-->
            ...
            <li class="nav-item p-0 ms-0">
                <a class="nav-link btn btn-color-gray-500 flex-center px-3" 
                data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="projects.html#kt_timeline_widget_4_tab_month">
                    <!--begin::Title-->
            ...
            <li class="nav-item p-0 ms-0">
                <a class="nav-link btn btn-color-gray-500 flex-center px-3" 
                data-kt-timeline-widget-4="tab" data-bs-toggle="tab" href="projects.html#kt_timeline_widget_4_tab_2022">
                    <!--begin::Title-->
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="kt_timeline_widget_4_tab_day" role="tabpanel" aria-labelledby="day-tab" data-kt-timeline-widget-4-blockui="true">
                <div class="table-responsive pb-10">
                    <!--begin::Timeline-->
                    <div id="kt_timeline_widget_4_1" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/oliver-html-pro/assets/media/"></div>
                    <!--end::Timeline-->
                </div>
            </div>
            <!--end::Tab pane-->
            ...
            <div class="tab-pane" id="kt_timeline_widget_4_tab_week" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-4-blockui="true">
                <div class="table-responsive pb-10">
                    <!--begin::Timeline-->
                    <div id="kt_timeline_widget_4_2" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/oliver-html-pro/assets/media/"></div>
                    <!--end::Timeline-->
                </div>
            </div>
            <!--end::Tab pane-->
            ...
            <div class="tab-pane" id="kt_timeline_widget_4_tab_month" role="tabpanel" aria-labelledby="month-tab" data-kt-timeline-widget-4-blockui="true">
                <div class="table-responsive pb-10">
                    <!--begin::Timeline-->
                    <div id="kt_timeline_widget_4_3" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/oliver-html-pro/assets/media/"></div>
                    <!--end::Timeline-->
                </div>
            </div>
            <!--end::Tab pane-->
            ...
            <div class="tab-pane" id="kt_timeline_widget_4_tab_2022" role="tabpanel" aria-labelledby="week-tab" data-kt-timeline-widget-4-blockui="true">
                <div class="table-responsive pb-10">
                    <!--begin::Timeline-->
                    <div id="kt_timeline_widget_4_4" class="vis-timeline-custom h-350px min-w-700px" data-kt-timeline-widget-4-image-root="/oliver-html-pro/assets/media/"></div>
                    <!--end::Timeline-->
                </div>
            </div>
            <!--end::Tab pane-->
...
<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
    ...
    <li class="menu-item"><a href="https://www.sgix.com.br" target="_blank" class="menu-link px-2">Purchase</a></li>
</ul>
<!--end::Menu-->    </div>
<!--end::Footer-->                            </div>
            <!--end:::Main-->
...
<div class="form-group">
	...
	<div class="mb-6">
		...
		<div class="fw-semibold text-muted fs-7 d-block lh-1">
			...
			<a class="fw-semibold" href="https://preview.keenthemes.com/html/oliver-html-pro/docs/getting-started/dark-mode" target="_blank">See docs</a>
		</div>
	</div>
	<!--end::Heading-->  
...
<div class="form-group d-flex flex-stack">           
	...
	<div class="d-flex flex-column">
		...
		<div class="fs-7 fw-semibold text-muted">
			...
			<a class="fw-semibold" href="https://preview.keenthemes.com/html/oliver-html-pro/docs/getting-started/rtl" target="_blank">See docs</a>
		</div>	
	</div>
	<!--end::Heading-->
...
<div class="form-group ">            
	...
	<div class="d-flex flex-column mb-4">
		...
		<div>
			...
			<a class="fw-semibold" href="https://preview.keenthemes.com/html/oliver-html-pro/docs/icons/keenicons" target="_blank">Learn more</a>
		</div>
	</div>
	<!--end::Heading-->
...
<div class="form-group d-flex flex-stack my-5">           
    ...
    <div class="d-flex justify-content-end">
        ...
        <div class="form-check form-check-solid form-check-custom form-check-success form-switch">
            ...
            value="true" name="layout-builder[layout][app][sidebar][display]" id="kt_builder_sidebar"/>
...
<div class="form-group d-flex flex-stack">           
    ...
    <div class="d-flex justify-content-end">
        ...
        <div class="form-check form-check-solid form-check-custom form-check-success form-switch">
            ...
            <input class="form-check-input w-45px h-30px" type="checkbox" checked value="true" name="layout-builder[layout][app][header][primary][sticky][enabled]" id="kt_builder_header_primary_sticky"/>
        ...
        <div class="pe-3 mb-5">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
                    <img src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-14.jpg" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">  
                ...
                <div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
                    ...
                    <div class="symbol symbol-circle symbol-25px">
                        <img src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-2.jpg" alt="img"/>
                    </div>
                    <!--end::User-->
        ...
        <div class="overflow-auto pe-3">
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
                    <img src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-1.jpg" alt="img"/>
                </div>  
                <!--end::User--> 
            </div>
            <!--end::Description-->
...
<div class="timeline-item">
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="mb-5 pe-3">
            <!--begin::Title-->
            <a href="projects.html#" class="fs-5 fw-semibold text-gray-800 text-hover-primary mb-2">3 New Incoming Project Files:</a>
            <!--end::Title-->
        ...
        <div class="overflow-auto pb-5">
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                ...
                <div class="d-flex flex-aligns-center pe-10 pe-lg-20">   
                    <!--begin::Icon-->                                  
                    <img alt="/oliver-html-pro/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/doc.svg"/>
                    <!--end::Icon--> 

                    <!--begin::Info--> 
                    <div class="ms-1 fw-semibold">
                        <!--begin::Desc--> 
                        <a href="projects.html#" class="fs-6 text-hover-primary fw-bold">Client UAT Testing Results</a>
                        <!--end::Desc--> 
                ...
                <div class="d-flex flex-aligns-center">   
                    <!--begin::Icon-->                                  
                    <img alt="/oliver-html-pro/apps/projects/project.html" class="w-30px me-3" src="assets/media/svg/files/css.svg"/>
                    <!--end::Icon--> 

                    <!--begin::Info--> 
                    <div class="ms-1 fw-semibold">
                        <!--begin::Desc--> 
                        <a href="projects.html#" class="fs-6 text-hover-primary fw-bold">Finance Reports</a>
                        <!--end::Desc--> 
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="pe-3 mb-5">
            ...
            <div class="fs-5 fw-semibold mb-2">
                Task <a href="projects.html#" class="text-primary fw-bold me-1">#45890</a>  
                merged with <a href="projects.html#" class="text-primary fw-bold me-1">#45890</a>  in “Ads Pro Admin Dashboard project:
            </div>
            <!--end::Title-->
            ...
            <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                ...
                <div class="overlay me-10">  
                    ...
                    <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                        <a href="projects.html#" class="btn btn-sm btn-primary btn-shadow">Explore</a>                                         
                    </div>   
                    <!--end::Link-->                                     
                </div>
                <!--end::Item-->
...
<div class="timeline-item">
    ...
    <div class="timeline-content mb-10 mt-n1">
        ...
        <div class="pe-3 mb-5">
            <!--begin::Title-->
            <div class="fs-5 fw-semibold mb-2">
                New case <a href="projects.html#" class="text-primary fw-bold me-1">#67890</a> 
            ...
            <div class="overflow-auto pb-5">
                ...
                <div class="d-flex align-items-center mt-1 fs-6">
                    ...
                    <!--begin::User-->
                    <a href="projects.html#" class="text-primary fw-bold me-1">Alice Tan</a>
                    <!--end::User--> 
                </div>
                <!--end::Wrapper-->
            </div>
...
<div class="notice d-flex bg-light-primary rounded border-primary border border-dashed min-w-lg-600px flex-shrink-0 p-6">
    ...
    <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
            ...
            <!--end::Content-->
                    ...
                    <!--begin::Action-->
            <a href="projects.html#" class="btn btn-primary px-6 align-self-center text-nowrap"  > 
                Proceed            </a>
            <!--end::Action-->
            </div>
    <!--end::Wrapper-->  
...
<div class="timeline-item">
    ...
    <div class="timeline-content mt-n1">
        ...
        <div class="pe-3 mb-5">
            <!--begin::Title-->
            <div class="fs-5 fw-semibold mb-2">
                New order <a href="projects.html#" class="text-primary fw-bold me-1">#67890</a> 
            ...
            <div class="d-flex align-items-center mt-1 fs-6">
                ...
                <!--begin::User-->
                <a href="projects.html#" class="text-primary fw-bold me-1">Jimmy Bold</a>
                <!--end::User--> 
            </div>
            <!--end::Description-->
        </div>
        ...
        <div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
            ...
            <div class="card-title">
                ...
                <div class="d-flex justify-content-center flex-column me-3">
                    <a href="projects.html#" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">Brian Cox</a>
...
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="projects.html#" class="menu-link px-3"  data-bs-toggle="modal" data-bs-target="#kt_modal_users_search">
            Add Contact
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-3">
        <a href="projects.html#" class="menu-link flex-stack px-3"  data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
            Invite Contacts
    ...
    <div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
        ...
        <div class="menu-sub menu-sub-dropdown w-175px py-4">
            <!--begin::Menu item-->
            <div class="menu-item px-3">
                <a href="projects.html#" class="menu-link px-3" data-bs-toggle="tooltip" title="Coming soon">
                    Create Group
                </a>
            </div>
            <!--end::Menu item-->
    ...
    <div class="d-flex justify-content-start mb-10 " >
        ...
        <div class="d-flex flex-column align-items-start">
            ...
            <div class="d-flex align-items-center mb-2">
                    ...
                    <!--begin::Details-->
                    <div class="ms-3">
                        <a href="projects.html#" class="fs-5 fw-bold text-gray-900 text-hover-primary me-1">Brian Cox</a>
        ...
        <div class="d-flex flex-column align-items-end">
            ...
            <div class="d-flex align-items-center mb-2">
                    ...
                    <div class="me-3">
                        ...
                        <a href="projects.html#" class="fs-5 fw-bold text-gray-900 text-hover-primary ms-1">You</a>  
                    </div>
                    <!--end::Details-->

                    <!--begin::Avatar--><div class="symbol  symbol-35px symbol-circle "><img alt="Pic" src="https://preview.keenthemes.com/oliver-html-pro/assets/media/avatars/300-1.jpg"/></div><!--end::Avatar-->                 
            </div>
            <!--end::User-->
    ...
    <div class="card card-flush w-100 rounded-0">
                ...
                <div class="d-flex flex-stack">                 
                    ...
                    <div class="d-flex flex-column me-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <a href="projects.html#" class="btn btn-sm btn-light-success btn-icon-success btn-icon w-25px h-25px me-2">
                                <i class="ki-duotone ki-minus fs-4"></i>                            </a>

                            <a href="projects.html#" class="btn btn-sm btn-light-success btn-icon w-25px h-25px">
        ...
        <div class="card-footer">
            ...
            <div class="d-flex justify-content-end mt-9">
                <a href="projects.html#" class="btn btn-primary d-flex justify-content-end">Pleace Order</a>
            </div>
            <!--end::Action-->
        </div>
        <!--end::Card footer--> 
...
<div class="rounded border border-dashed border-gray-300 py-6 px-8 mb-5">
    ...
    <!--begin::Purchase-->
    <div class="mb-7">
        <a href="https://www.sgix.com.br" class="btn btn-lg explore-btn-primary w-100">					
            Buy Now
        </a>
    </div>
    <!--end::Purchase-->
		...
		<div class="card-body" id="kt_help_body">
			...
			<div 
				...
				<!--end::Support-->
														...
														<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/oliver-html-pro/docs"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
					...
					<!--end::Link-->
														<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/oliver-html-pro/docs/base/utilities"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
					...
					<!--end::Link-->
																			<!--begin::Link-->
					<a href="https://preview.keenthemes.com/html/oliver-html-pro/docs/getting-started/changelog"  class="parent-hover d-flex align-items-center mb-7">
						<!--begin::Icon-->
            ...
            <div class="modal-body pt-0 pb-15 px-5 px-xl-20">
                ...
                <div class="mb-13 text-center">
                    ...
                    <div class="text-muted fw-semibold fs-5">
                        If you need more info, please check <a href="projects.html#" class="link-primary fw-bold">Pricing Guidelines</a>.
                    </div>
                </div>
                <!--end::Heading-->
                        ...
                        <div class="col-lg-6 mb-10 mb-lg-0">
                            ...
                            <div class="nav flex-column">
                                    ...
                                    <!--end::Tab link-->
                                        ...
                                        <!--begin::Price-->
                                        <div class="ms-5">
                                                                                            <a href="projects.html#" class="btn btn-sm btn-success">Contact Us</a>
                                                                                    </div>
                                        <!--end::Price-->
                                    </label>
                                    <!--end::Tab link-->
...
<!--end::Modal - Create App--><!--begin::Modal - Create Project-->
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                    ...
                    <div class="text-muted fw-semibold fs-5">
                        ...
                        <a href="projects.html#" class="link-primary fw-bold">Users Directory</a>.
                    </div>
                    <!--end::Description-->
                </div>
                <!--end::Heading-->
                    ...
                    <div class="mh-375px scroll-y me-n7 pe-7">
                            ...
                            <div class="d-flex flex-stack py-5 border-bottom border-gray-300 border-bottom-dashed">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-6">
                                        <!--begin::Name-->
                                        <a href="projects.html#" class="d-flex align-items-center fs-5 fw-bold text-gray-900 text-hover-primary">
                                            Emma Smith   
...
<!--end::Modal - View Users--><!--begin::Modal - New Address-->
<div class="modal fade" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="projects.html#" id="kt_modal_new_address_form">
                <!--begin::Modal header-->
...
<div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-9 p-6">
    ...
    <div class="d-flex flex-stack flex-grow-1 ">
            ...
            <div class=" fw-semibold">
                                    ...
                                    <div class="fs-6 text-gray-700 ">Updating address may affter to your <a href="projects.html#">Tax Location</a></div>
                            </div>
            <!--end::Content-->
...
<div data-kt-search-element="suggestions">
    ...
    <div class="mh-375px scroll-y me-n7 pe-7">
                                <!--begin::User-->
            <a href="projects.html#" class="d-flex align-items-center p-3 rounded bg-state-light bg-state-opacity-50 mb-1">
                <!--begin::Avatar-->
