...
<html lang="en" >
   ...
   <body  
                     ...
                     <div class="d-flex flex-column flex-column-fluid">
                                 ...
                                 <div class="d-flex align-items-center gap-3 gap-lg-5">
                                    <div class="m-0">
                                       ...
                                       <?php 
                                          ...
                                          if($usergroup == "admin"):
                                       ?>
                                          <a href="pages.html" class="btn btn-flex btn-sm btn-color-gray-700 bg-body fw-bold px-4 ml-4">                         
                                             Ver Páginas
                                          </a>
                                       <?php endif; ?>

                                       &nbsp;        
                                       <a href="posts.html" class="btn btn-flex btn-sm btn-color-gray-700 bg-body fw-bold px-4">                         
                                          Ver Posts
                                       </a>           
                                    </div>
                                 </div>
                        ...
                        <div id="kt_app_content" class="app-content  pb-0 " >
                           <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                              <?php include('../components/welcome/welcome.inc.php'); // welcome ?>
                              <?php include('../../addons/calendar/widget.inc.php'); // calendar ?>
                           </div>
                        </div>
                     </div>
      ...
      <?php include('../components/modals/projects/projects.inc.php'); ?>
      <?php include('../components/modals/invite/invite.inc.php'); ?>
