                     ...
                     <div class="d-flex flex-column flex-column-fluid">
                                 ...
                                 <div class="d-flex align-items-center gap-3 gap-lg-5">
                                    <div class="m-0">     
                                       <?php 
                                          ...
                                          if($usergroup == "admin"):
                                       ?>
                                       <a href="projects-add.html#" class="btn btn-flex btn-sm btn-color-gray-700 bg-body fw-bold px-4">                         
                                          <?= PRJ_NEW; ?>
                                       </a>
                                       <?php endif; ?>      
                                    </div>
                        ...
                        <div id="kt_app_content" class="app-content  pb-0 " >
                           ...
                           <div class="row gx-5 gx-xl-10 mb-xl-10">
                              <?php include('../components/custom/component-project-list/project-list.inc.php'); ?>
                           </div>
