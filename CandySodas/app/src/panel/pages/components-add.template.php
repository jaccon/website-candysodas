...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (CMS::saveComponent($dataToSave)) {
   ...
   <body  
                              ...
                              <div id="kt_account_settings_profile_details" class="collapse show">
                                 <form 
                                    ...
                                    <div class="card-body border-top p-9">
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"><?= CORE_DESC; ?></label>
                                          <div class="col-lg-8">
                                             <div class="row">
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             ...
                                             >
                                                <option value="enabled"><?= STATUS_ENABLED; ?></option>
                                                <option value="disabled"><?= STATUS_DISABLED; ?></option>
                                             </select>
                                          </div>
                                       </div>
      ...
      <script>
         ...
         if (urlParams.has('success')) {
            const savedUuid = urlParams.get('uuid');
            ...
            Swal.fire({
               ...
               if (savedUuid) {
                  ...
                  window.location.href = `components-update.html?id=${savedUuid}`;
               } else {
                  location.reload();
               }
            });
