                              ...
                              <div class="d-flex flex-stack flex-wrap gap-4 w-100">
                                 <div class="page-title d-flex flex-column gap-3 me-3">
                                    ...
                                    <h1 class="page-heading d-flex flex-column justify-content-center text-gray-900 fw-bolder fs-2x my-0">
                                      <span id="gTitle"> Catalog Product Add </span>
                                    </h1>
                                                      ...
                                                      <div class="mb-10 fv-row">
                                                        ...
                                                        <select 
                                                          ...
                                                          >
                                                            ...
                                                            <option value="master">  Product Master </option>
                                                         </select>
                                                      </div>
                                                      <div class="mb-10 fv-row">
                                                        ...
                                                        <select 
                                                          ...
                                                          >
                                                            ...
                                                            <option value="variation">  Disable </option>
                                                         </select>
                                                      </div>
                                                      <div class="mb-10 fv-row">
      ...
      <script>
        ...
        if (urlParams.has('success')) {
            Swal.fire({
                ...
                if (lastUuid) {
                    window.location.href = `post-update.html?id=${lastUuid}`;
                } else {
