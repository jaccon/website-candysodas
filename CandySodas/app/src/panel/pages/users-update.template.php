...
if ($projectId) {
    $loadData = helperUsers::getUsersById($projectId);
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if(!$_POST['password']) {
    $password = Auth::getUserData($_SESSION['user'], "password");
  } else {
  ...
  if (helperUsers::updateUserById($projectId, $dataToSave)) {
                                 ...
                                 <form 
                                    ...
                                    <div class="card-body border-top p-9">
                                      ...
                                      <div class="row mb-6">
                                          ...
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> Usergroup </label>
                                          
                                          <div class="col-lg-8 fv-row">
                                             <select 
                                                name="usergroup" 
                                                data-placeholder="Select usergroup..." 
                                                class="form-select form-select-solid form-select-lg"
                                              >
                                                <option value="admin" <?= CMS::isSelected('admin', $loadData['usergroup'] ?? ''); ?> > Administrator </option>
                                                <option value="supplyer" <?= CMS::isSelected('supplyer', $loadData['usergroup'] ?? ''); ?> > Supplyer </option>
                                                <option value="customer" <?= CMS::isSelected('customer', $loadData['usergroup'] ?? ''); ?> > Customer </option>
                                             </select>
                                             <div class="form-text">
                                                Select the usergroup for new register
                                             </div>
                                          </div>
                                      </div>
                                      ...
                                      <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <select 
                                                ...
                                                class="form-select form-select-solid form-select-lg"
                                              >
                                                <option value="ptbr" <?= CMS::isSelected('ptbr', $loadData['language'] ?? ''); ?> >  PTBR </option>
                                                <option value="en" <?= CMS::isSelected('en', $loadData['language'] ?? ''); ?> > EN </option>
                                                <option value="es" <?= CMS::isSelected('es', $loadData['language'] ?? ''); ?> > ES </option>
                                             </select>
                                             <div class="form-text">
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              value="" />
                                              <div class="form-text">
                                                Password using alphanumeric with min. 8 characters, max 12 characters. <br/> If you dont need update password just blank field
                                             </div>
                                          </div>
                                       </div>
