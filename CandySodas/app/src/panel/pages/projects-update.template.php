...
$projectDeadline = isset($projectData['projectDeadline']) ? date('Y-m-d', $projectData['projectDeadline']) : '';
$totalLaborCost = $projectData['totalLaborCost'] ?? '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $updatedData = [
        ...
        'projectDeadline' => $projectDeadlineTimestamp,
        'totalLaborCost' => $_POST['totalLaborCost'],
    ...
    helperProjects::updateProjectById($projectId, $updatedData);
    Auth::logUserAction(Auth::getUserData($_SESSION['user'], "id"),'update_project:'.$projectId);
   }
?>
                          ...
                          <?php include('../components/my-account/resume.inc.php'); ?>
                           ...
                           <div class="card mb-5 mb-xl-10">
                              ...
                              <div class="card-header border-0" >
                                 ...
                                 <a href="projects-view.html?id=<?= $projectId; ?>" 
                                    class="btn btn-sm btn-primary align-self-center">
                                    <?= PVIEW_PROJECT_RESUME_10; ?>                             
                                 </a>
                                    ...
                                    <div class="card-body border-top p-9">
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                            <span class="required"> <?= PRJ_ADD_04; ?> </span>
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> Customer Id </label>
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             ...
                                             <select 
                                                ...
                                                data-placeholder="Choose a project customer..." 
                                              ...
                                              >
                                                ...
                                                <?php 
                                                $customers = helperCustomers::getEnabledCustomers();
                                                foreach ($customers as $customer): ?>
                                                   <option 
                                                      value="<?= htmlspecialchars($customer['id']); ?>" 
                                                      <?= CMS::isSelected($customer['id'], $projectData['customerId']); ?> 
                                                   > 
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> <?= PRJ_ADD_07; ?> </span>
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="<?= PRJ_ADD_07; ?>" 
                                              value="<?= date('Y-m-d', $projectData['projectDeadline'] ?? time()); ?>" />
                                          </div>
                                       </div>

                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> <?= PRJ_ADD_08; ?> </span>
                                          <span class="ms-1"  data-bs-toggle="tooltip" title="Phone number must be active" >
                                          <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>                    </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="<?= PRJ_ADD_08; ?>" 
                                              value="<?= $projectData['totalProjectCost'] ?? ''; ?>" />
                                          </div>
                                       </div>

                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> <?= PRJ_ADD_09; ?> </span>
                                          <span class="ms-1"  data-bs-toggle="tooltip" title="Phone number must be active" >
                                          <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>                    </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              name="totalLaborCost" 
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="<?= PRJ_ADD_09; ?>" 
                                              value="<?= $projectData['totalLaborCost'] ?? ''; ?>" />
                                          </div>
                                       </div>

                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> <?= PRJ_ADD_10; ?> </span>
                                          <span class="ms-1"  data-bs-toggle="tooltip" title="Phone number must be active" >
                                          <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span>                    </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              name="profit" 
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="<?= PRJ_ADD_10; ?>" 
                                              value="<?= $projectData['profit'] ?? ''; ?>" />
                                          </div>
                                       </div>

                                       <div class="row mb-6">
                                          
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> <?= PRJ_ADD_11; ?> </label>
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <select 
                                                ...
                                                class="form-select form-select-solid form-select-lg"
                                              >
                                                <option value="1" <?= CMS::isSelected('1', $projectData['paymentMethod'] ?? ''); ?> > <?= PRJ_PAY_01; ?> </option>
                                                <option value="2" <?= CMS::isSelected('2', $projectData['paymentMethod'] ?? ''); ?> > <?= PRJ_PAY_02; ?> </option>
                                                <option value="3" <?= CMS::isSelected('3', $projectData['paymentMethod'] ?? ''); ?> > <?= PRJ_PAY_03; ?> </option>
                                                <option value="4" <?= CMS::isSelected('4', $projectData['paymentMethod'] ?? ''); ?> > <?= PRJ_PAY_04; ?> </option>
                                                <option value="5" <?= CMS::isSelected('5', $projectData['paymentMethod'] ?? ''); ?> > <?= PRJ_PAY_05; ?> </option>
                                                <option value="6" <?= CMS::isSelected('6', $projectData['paymentMethod'] ?? ''); ?> > <?= PRJ_PAY_06; ?> </option>
                                             </select>
                                             <div class="form-text">
                                                <?= PRJ_PAY_STR_02; ?>
                                             </div>
                                       ...
                                       <div class="row mb-6">
                                          ...
                                          <label class="col-lg-4 col-form-label required fw-semibold fs-6"> <?= PRJ_UP_02; ?> </label>
                                          ...
                                          <div class="col-lg-8 fv-row">
                                             <select 
                                                ...
                                                class="form-select form-select-solid form-select-lg"
                                              >
                                                <option value="working" <?= CMS::isSelected('working', $projectData['status'] ?? ''); ?> > <?= PRJ_STATUS_01; ?> </option>
                                                <option value="cancelled" <?= CMS::isSelected('cancelled', $projectData['status'] ?? ''); ?> > <?= PRJ_STATUS_02;?>  </option>
                                                <option value="late" <?= CMS::isSelected('late', $projectData['status'] ?? ''); ?> > <?= PRJ_STATUS_03;?> </option>
                                                <option value="waiting" <?= CMS::isSelected('waiting', $projectData['status'] ?? ''); ?> > <?= PRJ_STATUS_04;?> </option>
                                             </select>
                                             <div class="form-text">
                                                <?= PRJ_UP_03; ?> 
                                             </div>
                                       ...
                                       <div class="row mb-6">
                                          <label class="col-lg-4 col-form-label fw-semibold fs-6">
                                          <span class="required"> <?= PRJ_UP_04; ?>  </span>
                                          <span class="ms-1"  data-bs-toggle="tooltip" title="Phone number must be active" >
                                          <i class="ki-duotone ki-information-5 text-gray-500 fs-6"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i></span> </label>
                                          <div class="col-lg-8 fv-row">
                                             <input 
                                              ...
                                              name="installments" 
                                              class="form-control form-control-lg form-control-solid" 
                                              placeholder="<?= PRJ_UP_04; ?>" 
                                              value="<?= $projectData['installments'] ?? ''; ?>" />
                                          </div>
                                       </div>
