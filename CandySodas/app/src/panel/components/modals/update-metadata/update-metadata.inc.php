...
global $CONFIG;
?>
<div class="modal bg-body fade" tabindex="-1" id="kt_modal_metadata_update">
                    ...
                    <div>
                        <div class="w-100">
                            ...
                            <div class="mb-10 fv-row">
                                <h1 class="fw-bold text-gray-900"> Title </h1>
                                <input 
                                  type="text" 
                                  name="title" 
                            ...
                            <div class="fv-row mb-8">
                                <h1 class="fw-bold text-gray-900"> Content </h1>
                                <textarea class="form-control form-control-solid" rows="3" placeholder="Comment here..." name="content" id="content"></textarea>
                                <input type="hidden" name="pubId" value="<?= htmlspecialchars($_GET['id']); ?>">
                            </div>

                            <div class="mb-10 fv-row">
                                <h1 class="fw-bold text-gray-900"> Metadata Type </h1>
                                <select 
                                    name="metadataType" 
                                    id="metadataType"
