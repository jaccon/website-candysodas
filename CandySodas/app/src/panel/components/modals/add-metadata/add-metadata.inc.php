                    ...
                    <div>
                        <div class="w-100">
                            ...
                            <div class="mb-10 fv-row">
                                <h4 class="fw-bold text-gray-900"> Component </h4>
                                <select 
                                    name="component" 
                                    id="component"
                                    required
                                    data-placeholder="Choose the component for metadata" 
                                    class="form-select form-select-solid form-select-lg"
                                >
                                    
                                     <option value=""> Choose the component </option>
                                    <?php foreach ($components as $component) : ?>
                                        <option value="<?= $component['id']; ?>"> <?= $component['title']; ?> </option>
                                    <?php endforeach; ?>

                                </select>
                                <div class="text-muted fs-7"> Related the component  </div>
                            </div>
