...
if (file_exists($jsonFilePath)) {
    ...
    if (is_array($alldatas)) {
        foreach ($alldatas as $data) {
            // Adicionar somente registros com usergroup = 'customer'
            if (isset($data['usergroup']) && $data['usergroup'] === 'customers') {
                $datas[] = $data;
            }
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    if ($itemIndex !== false && isset($projectsData[$itemIndex]['usergroup']) && $projectsData[$itemIndex]['usergroup'] === 'customers') {
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex justify-content-start flex-column">
                                      <a href="customers-update.html?id=<?= $item['id']; ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
