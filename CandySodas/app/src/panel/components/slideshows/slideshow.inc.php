...
if (file_exists($jsonFilePath)) {
    ...
    if (is_array($alldatas)) {
        foreach ($alldatas as $data) {
            // Adicionado a condição para exibir apenas se metadataType for slideshow
            if ($data['metadataType'] === 'slideshow' && ($usergroup === 'admin' || $data['customerId'] === $customerId)) {
                $datas[] = $data;
            }
        }
            ...
            <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                <thead>
                  <tr class="fs-7 fw-bold text-gray-500 border-bottom-0">
                      ...
                      <th class="p-0 pb-3 text-end"> Slideshow Type </th>
                      ...
                      <?php if (!empty($paginatedData['data'])): ?>
                          ...
                          <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                      <a href="slideshow-update.html?id=<?= $item['id']; ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
                              ...
                              <td class="text-end pe-0">
                                ...
                                <a href="slideshow-update.html?id=<?= $item['id']; ?>" alt="Edit data" title="Edit data"> 
