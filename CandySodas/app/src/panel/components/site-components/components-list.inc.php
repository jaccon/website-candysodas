...
$projectsFile = '../../cached/components.json';
                      ...
                      <?php if (!empty($paginatedData['data'])): ?>
                          ...
                          <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                      <a href="components-update.html?id=<?= $item['id']; ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
                              ...
                              <td class="text-end pe-0">
                                ...
                                <a href="components-update.html?id=<?= $item['id']; ?>" alt="Edit data" title="Edit data"> 
