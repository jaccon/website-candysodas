...
$jsonFilePath = $CONFIG['CONF']['cacheDir'].'/posts.json';
$datas = [];
...
$projectsFile = '../../cached/posts.json';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['id'])) {
    ...
    if ($itemIndex !== false && Auth::getUserData($_SESSION['user'], "usergroup") === "admin") {
      ...
      exit();
        ...
        echo "<script>alert('Operação não permitida. Apenas usuários do grupo \"admin\" podem ser manipulados.'); window.location.href = 'posts.html';</script>";
        exit();
    }
                              ...
                              <td>
                                <div class="d-flex align-items-center">
                                    <div class="d-flex justify-content-start flex-column">
                                      <a href="post-update.html?id=<?= $item['id']; ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">
