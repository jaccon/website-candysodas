...
$pageId = "index";
$pageTitle = "Pesquisa de Produtos";
$query = Security::inputSanitizer(isset($_GET['query']) ? htmlspecialchars($_GET['query']) : '');
?>
<!DOCTYPE html>
...
<head>
 ...
 <body>      
  ...
  <section class="breadcrumb-areav2" data-background="images/banner/4.jpg" style="background-image: url(&quot;images/banner/4.jpg&quot;);">
                  ...
                  <div class="bread-titlev2">
                     ...
                     <div class="email-subs-form mt60">
                        <form action="search.html">
                           <input 
                            type="text" 
                            placeholder="Digite a nome ou SKU..." 
                            name="q"
                            value="<?= $query; ?>"
                            class="no-shadow">
                           <button 
    ...
    <?php include('../components/products/search.php'); ?>
